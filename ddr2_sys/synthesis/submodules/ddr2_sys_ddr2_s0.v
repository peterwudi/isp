...
// 
// Generated using ACDS version 13.0sp1 232 at 2013.10.26.15:46:19

`timescale 1 ps / 1 ps
module ddr2_sys_ddr2_s0 (
	...
	rw_manager_ddr2 #(
		...
		.HCX_COMPAT_MODE                      (0),
		.DEVICE_FAMILY                        ("STRATIXIII"),
		.AC_ROM_INIT_FILE_NAME                ("ddr2_sys_ddr2_s0_AC_ROM.hex"),
		.INST_ROM_INIT_FILE_NAME              ("ddr2_sys_ddr2_s0_inst_ROM.hex"),
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (25600),
		.INIT_FILE        ("ddr2_sys_ddr2_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	ddr2_sys_ddr2_s0_addr_router addr_router (
	...
	ddr2_sys_ddr2_s0_addr_router_001 addr_router_001 (
	...
	ddr2_sys_ddr2_s0_addr_router_002 addr_router_002 (
	...
	ddr2_sys_ddr2_s0_id_router id_router (
	...
	ddr2_sys_ddr2_s0_id_router id_router_001 (
	...
	ddr2_sys_ddr2_s0_id_router id_router_002 (
	...
	ddr2_sys_ddr2_s0_id_router_003 id_router_003 (
	...
	ddr2_sys_ddr2_s0_id_router id_router_004 (
	...
	ddr2_sys_ddr2_s0_id_router_005 id_router_005 (
	...
	ddr2_sys_ddr2_s0_cmd_xbar_demux cmd_xbar_demux (
		.clk                (avl_clk),                           //       clk.clk
		.reset              (sequencer_rst_reset_out_reset),     // clk_reset.reset
	...
	ddr2_sys_ddr2_s0_cmd_xbar_demux_001 cmd_xbar_demux_001 (
		.clk                (avl_clk),                               //        clk.clk
		.reset              (sequencer_rst_reset_out_reset),         //  clk_reset.reset
	...
	ddr2_sys_ddr2_s0_cmd_xbar_demux_002 cmd_xbar_demux_002 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (sequencer_rst_reset_out_reset),         // clk_reset.reset
	...
	ddr2_sys_ddr2_s0_cmd_xbar_mux_003 cmd_xbar_mux_003 (
		.clk                 (avl_clk),                               //       clk.clk
		.reset               (sequencer_rst_reset_out_reset),         // clk_reset.reset
	...
	ddr2_sys_ddr2_s0_cmd_xbar_mux_005 cmd_xbar_mux_005 (
		.clk                 (avl_clk),                               //       clk.clk
		.reset               (sequencer_rst_reset_out_reset),         // clk_reset.reset
	...
	ddr2_sys_ddr2_s0_cmd_xbar_demux_002 rsp_xbar_demux (
		.clk                (avl_clk),                           //       clk.clk
		.reset              (sequencer_rst_reset_out_reset),     // clk_reset.reset
	...
	ddr2_sys_ddr2_s0_cmd_xbar_demux_002 rsp_xbar_demux_001 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (sequencer_rst_reset_out_reset),         // clk_reset.reset
	...
	ddr2_sys_ddr2_s0_cmd_xbar_demux_002 rsp_xbar_demux_002 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (sequencer_rst_reset_out_reset),         // clk_reset.reset
	...
	ddr2_sys_ddr2_s0_rsp_xbar_demux_003 rsp_xbar_demux_003 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (sequencer_rst_reset_out_reset),         // clk_reset.reset
	...
	ddr2_sys_ddr2_s0_cmd_xbar_demux_002 rsp_xbar_demux_004 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (sequencer_rst_reset_out_reset),         // clk_reset.reset
	...
	ddr2_sys_ddr2_s0_rsp_xbar_demux_005 rsp_xbar_demux_005 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (sequencer_rst_reset_out_reset),         // clk_reset.reset
	...
	ddr2_sys_ddr2_s0_rsp_xbar_mux rsp_xbar_mux (
		.clk                 (avl_clk),                               //       clk.clk
		.reset               (sequencer_rst_reset_out_reset),         // clk_reset.reset
	...
	ddr2_sys_ddr2_s0_rsp_xbar_mux_001 rsp_xbar_mux_001 (
		.clk                 (avl_clk),                               //       clk.clk
		.reset               (sequencer_rst_reset_out_reset),         // clk_reset.reset
	...
	ddr2_sys_ddr2_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk
		.reset      (sequencer_rst_reset_out_reset), // clk_reset.reset
