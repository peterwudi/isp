...
add_fileset_file mem_read_buffer.v VERILOG PATH components/mem_read_buffer.v TOP_LEVEL_FILE
...
add_interface_port conduit_end control_read_base export Input ADDRESSWIDTH
add_interface_port conduit_end control_read_length export Input ADDRESSWIDTH
