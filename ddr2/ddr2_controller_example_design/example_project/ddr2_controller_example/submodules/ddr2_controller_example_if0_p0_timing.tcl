...
# Global variable to switch between MACRO/Micro models
# The value of this variable should NOT be modified unless
# the user is sure about the implications of this choice
set ::GLOBAL_ddr2_controller_example_if0_p0_phy_use_micro_timing 0
if { [ string match -nocase "HARDCOPY III*" [ get_family_string ] ] } {
	# HardCopy IV only supports the micro timing model
	set ::GLOBAL_ddr2_controller_example_if0_p0_phy_use_micro_timing 1
}
