...
add_fileset_file mem_write_buffer.v VERILOG PATH mem_write_buffer.v TOP_LEVEL_FILE
...
add_interface_port conduit_end_1 write_addr export Input 20
add_interface_port conduit_end_1 iData export Input 32
add_interface_port conduit_end_1 write export Input 1
add_interface_port conduit_end_1 write_done export Output 1
