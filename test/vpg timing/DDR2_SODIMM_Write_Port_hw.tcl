...
# Mon Aug 23 10:01:34 CST 2010
# DO NOT MODIFY


# +-----------------------------------
# | 
# | DDR2_SODIMM_Write_Port "DDR2_SODIMM_Write_Port" v1.0
# | Jeff Chou 2010.08.23.10:01:34
# | 
# | 
# | E:/D5M/cd/Demonstration/DE4_230_D5M_DVI/DDR2_SODIMM_Write_Port.v
# | 
# |    ./DDR2_SODIMM_Write_Port.v syn
# | 
# +-----------------------------------
...
# +-----------------------------------
# | module DDR2_SODIMM_Write_Port
# | 
set_module_property DESCRIPTION ""
set_module_property NAME DDR2_SODIMM_Write_Port
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property GROUP Terasic
set_module_property AUTHOR "Jeff Chou"
set_module_property DISPLAY_NAME DDR2_SODIMM_Write_Port
set_module_property TOP_LEVEL_HDL_FILE DDR2_SODIMM_Write_Port.v
set_module_property TOP_LEVEL_HDL_MODULE DDR2_SODIMM_Write_Port
...
# | files
# | 
add_file DDR2_SODIMM_Write_Port.v SYNTHESIS
# | 
# +-----------------------------------
...
# | parameters
# | 
add_parameter DATA_WIDTH_BITS INTEGER 128 ""
...
set_parameter_property DATA_WIDTH_BITS DESCRIPTION ""
...
add_parameter PORT_SIZE_BYTES INTEGER 1104000
...
add_parameter BURST_CNT INTEGER 8
set_parameter_property BURST_CNT DEFAULT_VALUE 8
set_parameter_property BURST_CNT DISPLAY_NAME BURST_CNT
set_parameter_property BURST_CNT TYPE INTEGER
set_parameter_property BURST_CNT ENABLED false
set_parameter_property BURST_CNT UNITS None
set_parameter_property BURST_CNT ALLOWED_RANGES -2147483648:2147483647
set_parameter_property BURST_CNT AFFECTS_GENERATION false
set_parameter_property BURST_CNT HDL_PARAMETER true
# | 
# +-----------------------------------
...
add_interface_port avalon_master oWRITE_DATA writedata Output 256
add_interface_port avalon_master oBYTE_ENABLE byteenable Output 32
...
add_interface_port conduit_end iWRITE_F export Input 1
add_interface_port conduit_end iWRITE_DATA_F export Input DATA_WIDTH_BITS
add_interface_port conduit_end oFULL_F export Output 1
add_interface_port conduit_end iFLUSH_REQ_F export Input 1
add_interface_port conduit_end oFLUSH_BUSY_F export Output 1
add_interface_port conduit_end iIP_INIT_DONE export Input 1
add_interface_port conduit_end c_state_flush export Output 5
add_interface_port conduit_end wrusedw export Output 9
